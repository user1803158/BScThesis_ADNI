...
pdf("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/CN/studyscale_baseline.pdf")
print(plot(pt0.CN, 
     ord = c(5,4,3,2,1),
     las = 1, 
...
# plot stacked transition probabilities 
pdf("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/CN/agecale_baseline.pdf")
...
# age
for (i in 1:length(age.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/CN/studyscale_age", unique(msCN$AGE[msCN$id == age.ids[i]]), ".pdf", sep="")
    pdf(file_name)
...
# sex
for (i in 1:length(sex.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/CN/studyscale_sex", unique(msCN$PTGENDER[msCN$id == sex.ids[i]]), ".pdf", sep="")
    pdf(file_name)
    print(pt.age.plots[[i]])
    dev.off()
}
...
# MMSE
for (i in 1:length(MMSE.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/CN/studyscale_MMSE", MMSEquant[i], ".pdf", sep="")
    pdf(file_name)
...
# APOE
for (i in 1:length(APOE.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/CN/studyscale_APOE", unique(msCN$APOE4[msCN$id == APOE.ids[i]]), ".pdf", sep="")
    pdf(file_name)
...
# age
for (i in 1:length(age.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/CN/agescale_age", unique(msCN.age$AGE[msCN.age$id == age.ids[i]]), ".pdf", sep="")
    pdf(file_name)
...
# sex
for (i in 1:length(sex.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/CN/agescale_sex", unique(msCN.age$PTGENDER[msCN.age$id == sex.ids[i]]), ".pdf", sep="")
    pdf(file_name)
...
# MMSE
for (i in 1:length(MMSE.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/CN/agescale_MMSE", MMSEquant[i], ".pdf", sep="")
    pdf(file_name)
...
# APOE
for (i in 1:length(APOE.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/CN/agescale_APOE", unique(msCN.age$APOE4[msCN.age$id == APOE.ids[i]]), ".pdf", sep="")
    pdf(file_name)

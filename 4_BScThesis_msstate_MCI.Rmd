...
pdf("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/MCI/studyscale_baseline.pdf")
print(plot(pt0.MCI, 
     ord = c(4,3,2,1),
     las = 1, 
...
# plot stacked transition probabilities 
pdf("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/MCI/agescale_baseline.pdf")
...
# age
for (i in 1:length(age.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/MCI/studyscale_age", unique(msMCI$AGE[msMCI$id == age.ids[i]]), ".pdf", sep="")
    pdf(file_name)
...
# sex
for (i in 1:length(sex.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/MCI/studyscale_sex", unique(msMCI$PTGENDER[msMCI$id == sex.ids[i]]), ".pdf", sep="")
    pdf(file_name)
...
# MMSE
for (i in 1:length(MMSE.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/MCI/studyscale_MMSE", MMSEquant[i], ".pdf", sep="")
    pdf(file_name)
...
# APOE
for (i in 1:length(APOE.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/MCI/studyscale_APOE", unique(msMCI$APOE4[msMCI$id == APOE.ids[i]]), ".pdf", sep="")
    pdf(file_name)
...
# age
for (i in 1:length(age.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/MCI/agescale_age", unique(msMCI.age$AGE[msMCI.age$id == age.ids[i]]), ".pdf", sep="")
    pdf(file_name)
...
# sex
for (i in 1:length(sex.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/MCI/agescale_sex", unique(msMCI.age$PTGENDER[msMCI.age$id == sex.ids[i]]), ".pdf", sep="")
    pdf(file_name)
...
# MMSE
for (i in 1:length(MMSE.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/MCI/agescale_MMSE", MMSEquant[i], ".pdf", sep="")
    pdf(file_name)
...
# APOE 
for (i in 1:length(APOE.ids)) {
    file_name = paste("/Users/lana/Library/Mobile Documents/com~apple~CloudDocs/Documents/Wiskunde/Jaar 3/Bachelorscriptie/Figuren manuscript/Probtrans/MCI/agescale_APOE", unique(msMCI.age$APOE4[msMCI.age$id == APOE.ids[i]]), ".pdf", sep="")
    pdf(file_name)
